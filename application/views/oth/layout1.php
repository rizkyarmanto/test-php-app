...
<script src="<?php echo media_url() ?>js/jquery-1.12.2.min.js" type="text/javascript"></script>
</head>
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo ucfirst($this->session->userdata('foto')); ?>" alt="user" class=""> <span class="hidden-md-down"><?php echo ucfirst($this->session->userdata('ufullname')); ?> &nbsp;<i class="fa fa-angle-down"></i></span> </a>
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                <a href="<?php echo site_url('kasn/profile'); ?>" class="dropdown-item"><i class="ti-user"></i> My Profile</a>
