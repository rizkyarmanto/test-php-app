...
<div class="container">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <table width="100%" class="table table-hover table-striped table-condensed" id="example">
                <thead>
                    <tr>
                        <th>Product Code</th>
                        <th>Product Name</th>
		            ...
		            for(i=0; i<data.length; i++){
		                html += '<tr>'+
		                        ...
		                        '<td style="text-align:right;">'+
                                    '<a href="javascript:void(0);" class="btn btn-info btn-sm item_edit" data-id="'+data[i].id+'" data-product_code="'+data[i].product_code+'" data-product_name="'+data[i].product_name+'" data-price="'+data[i].product_price+'">Edit</a>'+' '+
