						  ...
						  <div align="center">
							<div class="dropdown">
							  ...
							  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
								    <a class="dropdown-item btn-sm" href="<?php echo site_url('m_user/add/'.$row['id_user']) ?>"><i class="fa fa-edit"></i> Ubah</a>
								    <a class="dropdown-item btn-sm item_delete"  data-id="<?php echo $row['id_user'] ?>" data-nm="<?php echo $row['nama'] ?>"><i class="fa fa-trash-o"></i> Hapus</a>
							  </div>
							</div>	          
						  </div>
						</td>
  ...
  <script>
	$(document).ready(function(){
        ...
        $('#btn_delete').on('click',function(){
            ...
            document.location.href="<?php echo site_url('m_user/del/')?>"+id_del;
        });
	});
  </script>